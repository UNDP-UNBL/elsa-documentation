...
.. important:: 
   ...
   This section is not required reading for the Protecting Nature workshops, since we will making use of our paid Gurobi solver license. It is worth familiarising yourself with the text below, in particular if you intend to use the ELSA tools locally without a Gurobi license.
...
.. note:: 
   ...
   For the Protecting Nature workshops please go the specific workshop directions for :ref:`using_gurobi` as part of :ref:`training_5`.
